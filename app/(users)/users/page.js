...
export default  function Page(){
  ...
  /* its ok
  const getPostsData = () => {
    axios.get('http://localhost/admin/api/users'
    ).then(data => {
      if (data.data) {
  ...
  //its ok
  // useEffect(() => {
  //   axios.get('http://localhost/admin/api/indexusers')
  //       .then(data => {
                  ...
                  <table className="min-w-full leading-normal">
                    ...
                    {/*     className="mx-auto object-cover rounded-full h-10 w-10 "/>*/}
                      ...
                      <div className="flex">
                        ...
                        <Link href={`/viewuser/${user.id}`}><i className="fa-solid fa-eye text-blue-500" ></i></Link>
