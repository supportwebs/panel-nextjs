...
function Page() {
    ...
    const handleSubmit = async (event) => {
        try {
            ...
            const response = await axios.post(`http://localhost/admin/api/addpreorder`, form,{
                headers:{
            ...
            window.location.href = `/viewpreorder/${response.data.data['id']}`; // فرضا "/view" مسیر صفحه ویو مربوط به نمایش رکورد است
        } catch (error) {
