...
function Page() {
    return (
        <body dir="rtl"
              className="bg-gray-100 dark:bg-gray-800 rounded-2xl h-screen flex flex-col justify-center items-center font-body">
                    ...
                    <div className="flex flex-col mb-2">
                        ...
                        <span
                            ...
                            <input type="text" id="sign-in-email"
                                   className=" rounded-l-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                   placeholder="ایمیل "/>
                        </div>
                    </div>
